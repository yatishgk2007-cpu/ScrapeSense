...
Open the deployed ScrapeSense application directly from the project README.

🎥 Demo Video

🎬 Demo video coming soon

The final demo recording will be added here after the recording is completed.

📌 The live website is available above. The demo video will be added before final submission.
